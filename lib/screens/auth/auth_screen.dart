...
import 'package:betterflutterapp/screens/no_connection/no_connection_screen.dart';
      ...
      body: Center(
        child: Consumer<ConnectivityChangeNotifier>(builder:
            (BuildContext context,
                ...
                Widget? child) {
          // verifie si la connexion internet est activé
                ...
                child: new Column(
                  children: [
                    ...
                    TextFormField(
                      ...
                      validator: (value) =>
                          !emailRegex.hasMatch(value!) || value.isEmpty
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        if (_formKey.currentState!.validate()) {
                          // on va au widget suivant
                          await widget.onChangedStep(
                            1,
                            _email,
                            _name,
                            _password,
